...
import 'draw.dart';
class view_noti_news extends StatefulWidget {
  const view_noti_news({Key? key}) : super(key: key);

  @override
  State<view_noti_news> createState() => _view_noti_newsState();
}

class _view_noti_newsState extends State<view_noti_news> {
  late List data;
  void List_function() async {
     var url = Uri.parse(login.url+"notification_news/user_view_notinews/");
