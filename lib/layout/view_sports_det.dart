...
import 'draw.dart';
class view_sports_det extends StatefulWidget {
  const view_sports_det({Key? key}) : super(key: key);

  @override
  State<view_sports_det> createState() => _view_sports_detState();
}

class _view_sports_detState extends State<view_sports_det> {
  late List data;
  void List_function() async {
    var url = Uri.parse(login.url+"sports_details/ user_view_sprtdet/");
                        ...
                        new Padding(
                          ...
                          child: new Column(
                            ...
                            children: <Widget>[
                              ...
                              // new Text('Link :' +" "+data[index]['link'].toString(), style: Theme
                              //     .of(context)
                              //     .textTheme
                              //     .titleMedium
                              // ),
